    ...
    return (
        <>
            <nav className="navbar">
                ...
                {/* Searchbox Area */}
                <div
                    className={`absolute py-4 px-[5vw] left-0 w-full mt-0.5 border-b border-grey bg-white top-full md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show ${
